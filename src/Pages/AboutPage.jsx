        ...
        <div className="relative container mx-auto px-6 mt-20 flex flex-col md:flex-row items-center gap-10 z-10">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 leading-relaxed text-sm md:text-base max-w-3xl mx-auto">
              Magnova Events was born from a dream, a dream to create, to
              inspire, and to bring people together through unforgettable
              ...
              transforming her passion for creativity into a thriving event
              brand.
              <br />
              <br />
              Today, Magnova Events is more than just decoration; it is a
              creative powerhouse that brings spaces to life. We do not just
              make venues look beautiful; we make them feel alive. From intimate
              private moments to grand celebrations, we design, plan, and style
              ...
              Event Planning and Coordination, Event Styling and Design,
              Ambience and Experience Creation, Lighting and Sound, Floral and
              Space Design, Kiddies Events, Ushers, Mascots and Bouncers,
              Corporate and Brand Events, Rentals, and Custom Props.
              <br />
              <br />
