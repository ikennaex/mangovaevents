        ...
        <div className="grid md:grid-cols-3 gap-10 text-left">
          ...
          <div className="bg-customYellow/10 rounded-3xl p-8 shadow-md hover:shadow-lg transition">
            ...
            <p className="text-gray-700 leading-relaxed">
              To craft unforgettable event experiences that reflect creativity,
              culture, and excellence, while ensuring seamless coordination,
          ...
          <div className="bg-customYellow/10 rounded-3xl p-8 shadow-md hover:shadow-lg transition">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              recognized across Africa for innovation, reliability, and timeless
          ...
          <div className="bg-customYellow/10 rounded-3xl p-8 shadow-md hover:shadow-lg transition">
            ...
            <ul className="text-gray-700 leading-relaxed space-y-2">
              ...
              <li>
                • <strong>Professionalism</strong> – We uphold high standards in
              ...
              <li>
                • <strong>Communication</strong> – We build trust through clear
                collaboration.
              </li>
              <li>
